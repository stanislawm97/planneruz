...
<div class="text-center mt-5">
    <form style="max-width: 350px; margin:auto;">
        ...
        <input type="email" id="emailAddress" class="form-control" placeholder="Adres email" required autofocus>
        <label for="password" class="sr-only">Hasło</label>
        <input type="passwrod" id="password" placeholder="Hasło" class="form-control">
